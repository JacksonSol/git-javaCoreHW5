    ...
    public void setCSVDump(String dump) {
        ConverterToInt converter = (array) -> {
            ...
            for (int j = 0; j < array.length; j++) {
                res[j]=Integer.parseInt(array[j]);
            }
            return res;
        };
...
public class CSV {
    ...
    public static void main(String[] args) {
        int[][] array = {{100,200,123},{300,400,500},{600,700,23}};
        ...
        if (data1.getCSVDump().equals(data2.getCSVDump())) {
            System.out.println("Данные одинаковы в загруженом и выгруженом объектах");
        } else {
            System.out.println("Данные различны в загруженом и выгруженом объектах");
        }
